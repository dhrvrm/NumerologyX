...
export const getProjectKey = () => process.env.NEXT_PUBLIC_APPWRITE_PROJECT_KEY;
...
export const getContactFormCollectionID = () =>
	process.env.NEXT_PUBLIC_APPWRITE_CONTACT_FORM_COLLECTION_ID;
