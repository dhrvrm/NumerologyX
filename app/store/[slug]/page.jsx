					...
					<div class='mt-6 sm:mt-8 lg:mt-0'>
						...
						<div class='mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8'>
							...
							<a
								href='#'
								title=''
								class='text-white mt-4 sm:mt-0 bg-orange-600 hover:bg-orange-700 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800 flex items-center justify-center'
								role='button'
							>
								<svg
									class='w-5 h-5 -ms-2 me-2'
