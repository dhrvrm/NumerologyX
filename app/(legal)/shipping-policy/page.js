	...
	return (
		<article className='max-w-xl mx-auto my-10 prose'>
			...
			<p>
				...
				to acknowledge receipt of your order. For Cash on Delivery (COD) orders,
			...
			<ul>
				<li>
					All orders are processed and dispatched within 2 business days,
					excluding Sundays and public holidays.
				</li>
				<li>
					Before dispatch, all items are thoroughly inspected and packaged
					securely.
				</li>
				<li>
					Once dispatched, you will receive a notification with tracking
					information.
				</li>
			</ul>
			...
			<p>
				...
				claim a refund. Please contact us at{' '}
			...
			<ul>
				<li>
					In case of receiving a damaged, defective, or incorrect product,
					please refuse to accept the package from the delivery partner and
					inform us immediately.
				</li>
				<li>
					For claims on damaged or missing items, an unboxing video is required,
